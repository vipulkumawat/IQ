...
available Python database interfaces:
...
https://www.tutorialspoint.com/mysql/index.htm
 ...
 example of connecting with MySQL database:
import MySQLdb
...
Durability − Once a transaction was committed, the effects are persistent, even after a system failure.
 ...
 Python DB API 2.0 provides two methods to either commit or rollback a transaction.
...
Your Python scripts should handle these errors, but before using any of the above exceptions, make sure your MySQLdb has support for that exception
